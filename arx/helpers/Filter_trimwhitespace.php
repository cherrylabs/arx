...
* 
* @version $Id: Tpl_Filter_trimwhitespace.php,v 1.4 2005/05/29 15:27:07 pmjones Exp $
*
*/
...
class Tpl_Filter_trimwhitespace extends Tpl_Filter {
	...
	*/
	...
	public static function filter($buffer)
	{
		...
		Tpl_Filter_trimwhitespace::replace(
			"@@@SAVANT:TRIM:SCRIPT@@@",
			$script_blocks,
			$buffer
		);
