...
define('ZE_LANGS' , json_encode($_config['langs']));
...
define('ZE_DBNAME', $_config['db_name']);
define('ZE_DBUSER', $_config['db_user']);
define('ZE_DBPASSWORD', $_config['db_pass']);
define('ZE_DBHOST', $_config['db_host']);
define('ZE_DBCHARSET', $_config['db_charset']);
define('ZE_DBTYPE', $_config['db_type']);
define('ZE_DBPREFIX', $_config['db_prefix']);
...
if (preg_match( '/loc/' , $_SERVER['SERVER_NAME'])) {
    ...
    $_config['facebook']['app_id'] = '';
    $_config['facebook']['app_secret'] = '';
    ...
    $_config['facebook']['app_id'] = '206342166168916';
    $_config['facebook']['app_secret'] = '42afbb4078f80b0c81ef6fc00261a72b';
